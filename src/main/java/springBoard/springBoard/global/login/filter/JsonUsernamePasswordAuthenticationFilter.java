package springBoard.springBoard.global.login.filter;
...
public class JsonUsernamePasswordAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
    ...
    private static final String CONTENT_TYPE = "application/json";      //json 타입의 테이터로만 로그인 진행
    ...
    public JsonUsernamePasswordAuthenticationFilter(ObjectMapper objectMapper){
        super(DEFAULT_LOGIN_REQUEST_MATCHER);       // 위에서 설정한  /oauth2/login/* 의 요청에, GET으로 온 요청을 처리하기 위해 설정
