...
class JwtServiceTest {
    ...
    public void extractRefreshToken_RefreshToken_추출() throws Exception {
        ...
        //when
        String extractRefreshToken = jwtService.extractRefreshToken(httpServletRequest).orElseThrow(()->new RuntimeException("토큰이 없습니다"));
    ...
    public void extractUsername_Username_추출() throws Exception {
        ...
        String requestAccessToken = jwtService.extractAccessToken(httpServletRequest).orElseThrow(()->new RuntimeException("토큰이 없습니다"));

        //when
        String extractUsername = jwtService.extractUsername(requestAccessToken).orElseThrow(()->new RuntimeException("토큰이 없습니다"));
